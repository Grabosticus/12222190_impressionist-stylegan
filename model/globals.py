...
LR_MAPPING_NETWORK_PER_RES = {
    res: 0.1 * lr for res, lr in LR_MODEL_PER_RES.items()
}
...
FADE_IN_PERCENTAGE = 0.5 # the percentage of images per resolution that are used to fade in new layers
ADAM_BETA1 = 0.0
ADAM_BETA2 = 0.99

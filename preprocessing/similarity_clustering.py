...
def visualize_clusters(image_paths, embeddings, labels, aspect_ratios, n_samples_per_cluster=20, perplexity=30):
    global OUTPUT_DIR
    # t-SNE
    ...
    for cluster_id in range(n_clusters):
        ...
        plt.suptitle(f'Cluster {cluster_id} - {len(cluster_indices)} images', fontsize=16)
        plt.tight_layout()
